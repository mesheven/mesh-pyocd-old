...
parser.add_argument("-t", dest = "target_override", default = None, help = "Override target to debug" )
...
try:
    ...
    # MbedBoard.chooseBoard(board_id = option.board_id, target_override = option.target_override)
    board = MbedBoard.chooseBoard(target_override = args.target_override)
